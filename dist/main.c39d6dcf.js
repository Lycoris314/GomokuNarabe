...
},{"process":"../node_modules/process/browser.js"}],"global.ts":[function(require,module,exports) {
"use strict";
...
},{"./global":"global.ts"}],"main.ts":[function(require,module,exports) {
"use strict";
...
var gomoku_1 = require("./gomoku"); //./は省略できない
var global_1 = require("./global");
(0, jquery_1.default)(function () {
  //碁盤の表示
  makeTable(19);
  function makeTable(N) {
    var tbody = (0, jquery_1.default)("<tbody>");
    for (var i = 0; i < N; i++) {
      var tr = (0, jquery_1.default)("<tr>");
      for (var j = 0; j < N; j++) {
        var td = (0, jquery_1.default)("<td>").addClass("cross").attr("data-y", i).attr("data-x", j);
        tr.append(td);
      }
      tbody.append(tr);
    }
    (0, jquery_1.default)("table.cross").append(tbody);
    var tbody2 = (0, jquery_1.default)("<tbody>");
    for (var i = 0; i < N - 1; i++) {
      var tr = (0, jquery_1.default)("<tr>");
      for (var j = 0; j < N - 1; j++) {
        var td = (0, jquery_1.default)("<td>").addClass("masu");
        tr.append(td);
      }
      tbody2.append(tr);
    }
    (0, jquery_1.default)("table.masu").append(tbody2);
  }
  var gomoku = new gomoku_1.GomokuNarabe(19);
  var inGame = true; //ゲームが終了したらfalse
  var comBattle = false; //COM対戦モードでtrue
  var comThinking = false; //COMのターン中true
  //碁盤の目をクリック
  (0, jquery_1.default)("td.cross").on("click", tdClickEvent);
  function tdClickEvent() {
    if (!inGame || comThinking) {
      return;
    }
    var y = Number((0, jquery_1.default)(this).attr("data-y"));
    var x = Number((0, jquery_1.default)(this).attr("data-x"));
    var state = gomoku.putStone(y + 1, x + 1);
    if (state !== null) {
      (0, jquery_1.default)("td.cross").removeClass("shadow");
      if (gomoku.turn == global_1.STONE.FIRST) {
        (0, jquery_1.default)(this).addClass("white shadow");
      } else {
        (0, jquery_1.default)(this).addClass("black shadow");
      }
      //テキスト更新
      writeText(state);
      function writeText(state) {
        var text = "";
        switch (state) {
          case global_1.GAME_STATE.PENDING:
            {
              text = gomoku.turn === global_1.STONE.FIRST ? "黒の番です。" : "白の番です。";
              break;
            }
          case global_1.GAME_STATE.WIN:
            {
              text = gomoku.turn === global_1.STONE.FIRST ? "白の勝ちです。" : "黒の勝ちです。";
              inGame = false;
              comBattle = false;
              break;
            }
          case global_1.GAME_STATE.DRAW:
            {
              text = "引き分けです。";
              inGame = false;
              comBattle = false;
        ...
        (0, jquery_1.default)("p.turn").text(text);
      }
      //COM対戦におけるCOMの手
      if (comBattle) {
        comThinking = true;
        setTimeout(function () {
          comThinking = true;
          var _a = gomoku.comNext(),
            y = _a[0],
            x = _a[1];
          var st = gomoku.putStone(y + 1, x + 1);
          var td = (0, jquery_1.default)("td.cross[data-y='".concat(y, "'][data-x='").concat(x, "']"));
          (0, jquery_1.default)("td.cross").removeClass("shadow");
          if (gomoku.turn == global_1.STONE.FIRST) {
  ...
  //リセットボタンクリック
  (0, jquery_1.default)("button.reset").on("click", function () {
    reset(gomoku.size);
    comBattle = false;
  });
  //設定ボタンクリック
  (0, jquery_1.default)("button.config").on("click", function () {
    (0, jquery_1.default)("div.config").addClass("show");
  });
  //あなたが先手クリック
  (0, jquery_1.default)("button.first").on("click", function () {
    reset(gomoku.size);
    comBattle = true;
    (0, jquery_1.default)("div.config").removeClass("show");
  });
  //あなたが後手クリック
  (0, jquery_1.default)("button.second").on("click", function () {
    reset(gomoku.size);
    comBattle = true;
    (0, jquery_1.default)("div.config").removeClass("show");
    var center = (gomoku.size - 1) / 2;
    gomoku.putStone(center + 1, center + 1);
    (0, jquery_1.default)("td.cross[data-y=".concat(center, "][data-x=").concat(center, "]")).addClass("black shadow");
    (0, jquery_1.default)("p.turn").text("白の番です。");
  });
  //サイズを19×19に変更
  (0, jquery_1.default)("#size19").on("change", function () {
    (0, jquery_1.default)("table.cross").empty();
    (0, jquery_1.default)("table.masu").empty();
    makeTable(19);
    (0, jquery_1.default)("td.cross").on("click", tdClickEvent);
    (0, jquery_1.default)("table.masu").removeClass("size11 size15");
    reset(19);
  });
  //サイズを15×15に変更
  (0, jquery_1.default)("#size15").on("change", function () {
    (0, jquery_1.default)("table.cross").empty();
    (0, jquery_1.default)("table.masu").empty();
    makeTable(15);
    (0, jquery_1.default)("td.cross").on("click", tdClickEvent);
    (0, jquery_1.default)("table.masu").addClass("size15");
    (0, jquery_1.default)("table.masu").removeClass("size11");
    reset(15);
  });
  //サイズを11×11に変更
  (0, jquery_1.default)("#size11").on("change", function () {
    (0, jquery_1.default)("table.cross").empty();
    (0, jquery_1.default)("table.masu").empty();
    makeTable(11);
    (0, jquery_1.default)("td.cross").on("click", tdClickEvent);
    (0, jquery_1.default)("table.masu").removeClass("size15");
    (0, jquery_1.default)("table.masu").addClass("size11");
    reset(11);
  });
  //戻るボタンをクリック
  (0, jquery_1.default)("button.back").on("click", function () {
    (0, jquery_1.default)("div.config").removeClass("show");
  });
  function reset(n) {
    gomoku = new gomoku_1.GomokuNarabe(n);
    (0, jquery_1.default)("td.cross").removeClass("black white shadow");
    (0, jquery_1.default)("p.turn").text("黒の番です。");
    inGame = true;
  }
});
},{"jquery":"../node_modules/jquery/dist/jquery.js","./gomoku":"gomoku.ts","./global":"global.ts"}],"../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
